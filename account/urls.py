...
from .views import register_view, login_view, logout_view, forgot_password, resetPass, RegisterApi, login_api, VerifyEmail, LogoutApi, UserApi, rehh, MyTokenObatinPairView
