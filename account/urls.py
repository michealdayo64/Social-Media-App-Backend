...
from .views import register_view, login_view, logout_view, forgot_password, resetPass, RegisterApi, VerifyEmail, LogoutApi, MyTokenObatinPairView
...
urlpatterns = [
    ...
    path('login_api/', MyTokenObatinPairView.as_view(), name='login-api'),
    path('verify_email/', VerifyEmail.as_view(), name='verify-email'),
    #path('token_serial/', MyTokenObatinPairView.as_view(), name="token-serial"),
